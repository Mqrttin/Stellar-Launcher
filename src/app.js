...
if (!app.requestSingleInstanceLock()) {
    ...
    app.whenReady().then(() => {
        console.log('[STELLAR] Creando UpdateWindow...');
...
ipcMain.on('main-window-open', () => {
    console.log('[STELLAR] main-window-open recibido');
    MainWindow.createWindow();
});
...
autoUpdater.on('update-available', () => {
    console.log('[STELLAR] update-available');
...
autoUpdater.on('update-not-available', () => {
    console.log('[STELLAR] update-not-available');
...
autoUpdater.on('error', err => {
    console.error('[STELLAR] AutoUpdater:', err);
